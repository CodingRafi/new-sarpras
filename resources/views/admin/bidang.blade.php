                                ...
                                <td class="text-center">
                                    <div>
                                        ...
                                        <form action="/bidang-kompetensi/{{ $bidang->id }}" method="post" class="d-inline-block">
                                            @csrf
                                            @method('delete')
                                            <button type="submit" class="btn btn-danger btn-hapus" onclick="return confirm('Apakah anda yakin akan menghapus bidang kompetensi ini? semua sekolah yang menggunakan bidang kompetensi ini akan terhapus')">Hapus</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
