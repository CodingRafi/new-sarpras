        ...
        <div class="card-header" style="display:flex; background-color: #25b5e9">
            <div class="col-10">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link text-white active font-weight-bold" href="#data-pengawas" data-toggle="tab">Pengawas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white font-weight-bold" href="#tambah-pengawas" data-toggle="tab">Tambah</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="/usulan-lahan" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" placeholder="Masukan Nama" id="nama" name="nama" required>
                            </div>
                            {{-- end input nama --}}
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" placeholder="Masukan Instansi" id="instansi" name="instansi" required>
                            </div>
        ...
        <div class="card mb-5">
            <div class="card-header" style="display:flex; background-color: #fcc12d">
                <div class="col-10">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link text-white active font-weight-bold" href="#data-verifikator" data-toggle="tab">Verifikator</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white font-weight-bold" href="#tambah-verifikator" data-toggle="tab">Tambah</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card mb-5">
                <div class="card-header" style="display:flex; background-color: #263238">
                    <div class="col-10">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link text-white active font-weight-bold" href="#data-unsur" data-toggle="tab">Unsur yang Diverifikasi</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="card-body">
                                <form action="/usulan-lahan" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-sm-9" placeholder="Masukan Unsur yang Diverifikasi" id="verifikator" name="verifikator" required>
                                    </div>
