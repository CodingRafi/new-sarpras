                            ...
                            @foreach ($komlis as $komli)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div>
                                            <button type="button" class="btn text-white btn-warning tombol-edit-komli"
                                                data-toggle="modal" data-target="#edit" data-id="{{ $komli->id }}">Edit
                                            </button>
                        ...
                        <form class="form-horizontal form-edit" action="/komli" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="bidang" class="col-sm-2 col-form-label">Bidang</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control input-bidang" id="bidang" name="bidang"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="program" class="col-sm-2 col-form-label">Program</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control input-program" id="program" name="program"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="kompetensi" class="col-sm-2 col-form-label">Kompetensi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control input-kompetensi" id="kompetensi"
