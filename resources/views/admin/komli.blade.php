...
<div class="card mt-2">
    <div class="card-header" style="background-color: #25b5e9">
        ...
        <button type="button" class="btn btn-tool border border-light text-white ml-3" data-toggle="modal" data-target="#tambah-kompetensi"><i class="bi bi-plus"></i> Tambah Kompetensi Keahlian</button>
    </div>
    <div class="card-body">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                      <div class="btn text-white" style="background-color: #00a65b">
                          <h5>Edit</h5>
                      </div>
                    </td>
                  </tr>
