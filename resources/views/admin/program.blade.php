...
@section('container')
     ...
     {{-- Loading --}}
    <div class="loading-program" style="position: fixed; background: rgba(0, 0, 0, 0.1); width: 100%; height: 100vh; z-index: 9999; display: flex; justify-content: center; align-items: center; top: 0; left: 0; display: none;">
                        ...
                        <form class="form-horizontal" action="/program-kompetensi" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control input-loading" id="program" name="nama" value="">
                                    </div>
                                </div>
                            </div>
