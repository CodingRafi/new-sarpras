...
@section('container')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark display-4" style="padding: 0 !important;">Ruang Perpustakaan</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header bg-warning d-flex p-0">
                <h3 class="card-title p-3 text-white">Ruang Perpustakaan</h3>
            </div>
            <div class="card-body">
                {{-- Table --}}
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" style="min-width: auto !important; width: 125px;">
                                                <a class="dropdown-item text-truncate kab" tabindex="-1"
                                                    href="/bangunan/perpustakaan-dinas?filter=kota">Kota/ Kabupaten</a>
                                                <a class="dropdown-item text-truncate kcd" tabindex="-1"
                                                    href="/bangunan/perpustakaan-dinas?filter=kcd">Kantor Cabang Dinas</a>
                                            </div>
                                        </li>
                                    </ul>
                                    <div class="md-2 col-11" style="max-width: 89%;">
                                        <form class="form-inline ml-2" action="/bangunan/perpustakaan-dinas" method="GET"
                                            style="width: 100%;">
