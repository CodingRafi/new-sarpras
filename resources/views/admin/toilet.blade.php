    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex p-0" style="background-color: #25b5e9">
                <h3 class="card-title p-3 text-white">Toilet</h3>
            </div>
            <div class="card-body">
                {{-- Table --}}
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" style="min-width: auto !important; width: 125px;">
                                                <a class="dropdown-item text-truncate kab" tabindex="-1"
                                                    href="/bangunan/toilet-dinas?filter=kota">Kota/ Kabupaten</a>
                                                <a class="dropdown-item text-truncate kcd" tabindex="-1"
                                                    href="/bangunan/toilet-dinas?filter=kcd">Kantor Cabang Dinas</a>
                                            </div>
                                        </li>
                                    </ul>
                                    <div class="md-2 col-11" style="max-width: 89%;">
                                        <form class="form-inline ml-2" action="/bangunan/toilet-dinas" method="GET"
                                            style="width: 100%;">
