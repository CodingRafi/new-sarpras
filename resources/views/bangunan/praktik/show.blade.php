...
<div class="container-fluid">
    <div class="info-box p-4 detail-infobox shadow-sm mb-5 bg-body rounded">
        ...
        <div class="dropdown-menu" style="margin-left: -56px">
            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#upload-logo">Upload Logo</button>
            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#ubah-deskripsi">Ubah Deskripsi</button>
        </div>
                        ...
                        <div class="modal-body">
                            <div class="card-body text-center">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" id="logo-kejuruan" name="#" style="height: auto !important;">
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="card-body text-center">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="deskripsi-ubah" rows="3"></textarea>
                                    </div>
                                </div>
                ...
                <div class="col-lg-5 col-12">
                    <div class="d-flex justify-content-center align-items-center flex-column p-2">
                        <img src="/img/Kompetensi Keahlian.png" style="width: 18rem"
                            class=" border rounded-circle float-start" alt="...">
