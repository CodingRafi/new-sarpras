        ...
        <div class="col-lg-3 col-6">
            <div class="card">
                ...
                <div class="card-header text-white" style="background-color: #25b5e9">
                    ...
                    <div class="card-tools">
                        @if (request('jenis') == 'toilet' || request('jenis') == 'lab_biologi' || request('jenis') ==
                        'lab_fisika' || request('jenis') == 'lab_komputer' || request('jenis') == 'lab_kimia' ||
                        request('jenis') == 'lab_ipa' || request('jenis') == 'lab_bahasa')
                ...
                <form action="/bangunan/usulan-ruang-kelas" method="post" enctype="multipart/form-data">
                    ...
                    <form action="/bangunan/usulan-toilet" method="post" enctype="multipart/form-data">
                        ...
                        <form action="/bangunan/usulan-ruang-perpustakaan" method="post" enctype="multipart/form-data">
                            @else
                            <form action="/bangunan/usulan-lab-komputer" method="post" enctype="multipart/form-data">
                                @endif
                                @csrf

                                @if (request('jenis') == 'lab_biologi' || request('jenis') == 'lab_fisika' ||
                                request('jenis') == 'lab_komputer' || request('jenis') == 'lab_kimia' ||
                                request('jenis') == 'lab_ipa' || request('jenis') == 'lab_bahasa')
                                ...
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="close tombol-exnya" data-dismiss="modal"
                                        aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-4 col-form-label pt-1 @error('proposal') is-invalid @enderror"
                                            value="{{ old('proposal') }}" for="customFile">Proposal</label>
                                        <input type="file" class="loading-tambah" id="proposal" accept=".pdf"
                                ...
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default tombol-Close"
