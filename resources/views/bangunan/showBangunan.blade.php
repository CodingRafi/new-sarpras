            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th class="text-center">{{ $loop->iteration }}</th>
                            <td class="text-center text-capitalize nama-laboratorium" data-id="{{ $jenis->id }}">
                                {{ $jenis->jenis }}</td>
                            <td class="text-center text-capitalize">
                                ...
                                <button type="button" class="btn btn-warning button-laboratorium text-white"
                                    data-toggle="modal" data-target="#edit-laboratorium" data-id="{{ $jenis->id }}">Edit
                                </button>
                ...
                <form class="form-horizontal form-laboratorium" action="/jenis-pimpinan" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="nama" class="col-sm-3 col-form-label">Jenis Laboratorium</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control input-nama-laboratorium" id="nama" name="jenis"
                                    required>
                            </div>
                        </div>
                    </div>
