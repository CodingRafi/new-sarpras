...
@section('container')
    ...
    <div class="form-edit pt-3">
        ...
        <form action="/bangunan/ruang-rehabrenov/{{ $data->id }}" method="post" enctype="multipart/form-data" onsubmit="myLoading()">
            @csrf
            @method('patch')
            <div class="card pt-3" style="background-color: white; border-radius: 10px; ">
                ...
                <div class="row input pl-5 mt-2">
                    <label class="col-2 mt-3">Jenis Usulan</label>
                    <select name="jenis" id="" class="custom-select col-sm-7" required>
                        ...
                        <option value="laboratorium" {{ ($data->jenis == 'laboratorium') ? 'selected' : '' }}>Laboratorium</option>
                        ...
                        <option value="ruang_penunjang" {{ ($data->jenis == 'ruang_penunjang') ? 'selected' : '' }}>Ruang Penunjang</option>
                    </select>
                </div>

                {{-- --------------------------------------------- LUAS LAHAN --------------------------------------------- --}}
                <div class="row input pl-5 mt-2">
                    <label class="col-2 mt-3">Persentase (%)</label>
                    <input type="number" class="col-9 form-control mt-2" style="width: 750px" placeholder="Masukan Persentase Kerusakan"
                        value="{{ $data->persentase }}" name="persentase" required>
                </div>

                <div class="row input pl-5 mt-2">
                    <label class="col-2 mt-3">Usia</label>
                    <input type="r]te" class="col-9 form-control mt-2" style="width: 750px" placeholder="Masukan Usia Bangunan"
                        value="{{ $data->usia }}" name="usia" required>
                </div>

                <div class="row input pl-5 mt-2">
                    <label class="col-2 mt-3">Objek</label>
                    <input type="text" class="col-9 form-control mt-2" style="width: 750px" placeholder="Masukan Objek Bangunan"
                        value="{{ $data->objek }}" name="objek" required>
                </div>
                ...
                <div class="row input pl-5 mt-2">
                    ...
                    <input type="number" class="col-9 form-control mt-2" style="width: 750px" placeholder="Masukan Luas Lahan"
                        value="{{ $data->luas_lahan }}" name="luas_lahan" required>
                </div>
                
                <div class="row input pl-5 mt-2">
                    <label class="col-2 mt-3">Luas Lahan</label>
                    <textarea id="" rows="5" class="col-9 form-control mt-2" name="keterangan" placeholder="Keterangan" required style="width: 77% !important;">{{ $data->keterangan }}</textarea>
                </div>
            ...
            e.addEventListener('click', function() {
                ...
                if (hasilConfirm == true) {
                    ...
                    const myTimeout = setTimeout(function() {
                        ...
                        $.ajax({
                            url: '/foto/delete-sigle-foto-rehab-renov/' + id,
                            dataType: 'json',
                            type: 'DELETE',
                            data: {
                                _method: 'delete',
