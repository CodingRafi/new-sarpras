...
@section('container')
    ...
    <div class="container-fluid">
                        ...
                        <div class="modal-content">
                            <form class="form-horizontal" method="post"
                                ...
                                <div class="modal-header bg-warning">
                                    <h4 class="modal-title text-white font-weight-bold">Ketersediaan</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
        ...
        <div class="card card-info">
            <div class="card-header" style="background-color: #25b5e9">
                <h3 class="card-title font-weight-bold">Usulan Lab Komputer</h3>
                <div class="card-tools">
                ...
                @if (count($usulanLabKomputers) > 0)
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach ($usulanLabKomputers as $key => $usulan)
                                    <tr>
                                        <th class="text-center">{{ $loop->iteration }}</th>
                                        <td class="text-center text-capitalize">{{ str_replace('_', ' ', $usulan->jenis) }}
                                        </td>
