...
@section('container')
    ...
    <div class="form-edit pt-3">
        ...
        <form action="/usulan-lahan/{{ $data->id }}" method="post" enctype="multipart/form-data" onsubmit="myLoading()">
            @csrf
            @method('patch')
            <div class="card pt-3" style="background-color: white; border-radius: 10px; ">
                ...
                <div class="row input pl-5 mt-2">
                    <label class="col-2 mt-3">Nama Usulan</label>
                    <input type="text" class="col-3 form-control mt-2" style="width: 750px" placeholder="Masukan Nama Usulan"
                ...
                <div class="row input pl-5 mt-2">
                    ...
                    <textarea name="alamat" id="" rows="5" class="col-9 form-control mt-2" style="width: 77%">{{ $data->alamat }}</textarea>
                </div>
