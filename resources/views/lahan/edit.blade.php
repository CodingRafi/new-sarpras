...
<div class="form-edit pt-3">
    <div class="card pt-3" style="background-color: white; border-radius: 10px; ">
        <div class="row input pl-5">
            ...
            <input type="text" class="col-9 form-control mt-3" placeholder="Masukan Nama Lahan">
        </div>

        <div class="row input pl-5">
            <label class="col-2 mt-3">Jenis Usulan</label>
            <input type="text" class="col-9 form-control mt-3" placeholder="Masuk Jenis Usulan">
        </div>

        <div class="row input pl-5">
            <label class="col-2 mt-3">Panjang</label>
            <input type="number" class="col-9 form-control mt-3" placeholder="Masukan Panjang Lahan">
        </div>

        <div class="row input pl-5">
            <label class="col-2 mt-3">Lebar</label>
            <input type="number" class="col-9 form-control mt-3" placeholder="Masukan Lebar Lahan">
        </div>

        <div class="row input pl-5">
            <label class="col-2 mt-3">Luas Lahan</label>
            <input type="number" class="col-9 form-control mt-3" placeholder="Masukan Luas Lahan">
        </div>

        <div class="row input pl-5">
            <label class="col-2 mt-3">Alamat</label>
            <input type="text" class="col-9 form-control mt-3" placeholder="Masukan Alamat">
        </div>

        <div class="row input pl-5">
            <label class="col-2 mt-3" for="customFile">Proposal Lahan</label>
            <input type="file" class="col-9 mt-3" id="gambar-lahan" required multiple accept="image/*" name="gambar[]">
        </div>
